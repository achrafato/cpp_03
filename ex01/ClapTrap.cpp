...
/*   Updated: 2024/10/02 17:57:32 by aibn-che         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(void) : name("name-c"), hit_p(10), energy_p(10), attack_p(0)
{
...
void    ClapTrap::attack(const string& target)
{
	if (!energy_p || !hit_p)
	{
		cout << "insufficient energy points (ClapTrap)" << endl;
		return ;
	}
